...
object RenderConfig {
    ...
    /** Max positions stored. At 5 cm spacing = 400 m of path — ample for indoor sessions. */
    const val TRAJECTORY_MAX_POINTS  = 8_000
    /** Minimum distance between two recorded positions (avoids redundant points when static). */
